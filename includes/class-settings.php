...
class class_social_share_button_settings  {
	...
	public function admin_menu() {
        ...
        $social_share_button_migrate_2_1_6 = get_option('social_share_button_migrate_2_1_6');
        ...
        if($social_share_button_migrate_2_1_6!='done')
            add_submenu_page( 'social_share_button', __( 'Migrate', 'social-share-button' ), __( 'Migrate', 'social-share-button' ), 'manage_options', 'social_share_button_migrate_settings', array( $this, 'migrate_settings' ) );
    ...
    public function migrate_settings(){
        ...
        include( 'menu/migrate-settings.php' );
    }
