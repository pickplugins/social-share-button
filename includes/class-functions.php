...
class class_social_share_button_functions{
	...
	public function social_share_button_sites($sites = array()){
        ...
        $sites[] = array('id'=>'email','title'=>__('Email','social-share-button'),'icon'=>'<i class="far fa-envelope"></i>','can_remove'=>'yes','visible'=>'yes','share_url'=>'mailto:?subject=TITLE&body=URL');
        $sites[] = array('id'=>'facebook','title'=>__('Facebook','social-share-button'),'icon'=>'<i class="fab fa-facebook-f"></i>','can_remove'=>'yes','visible'=>'yes','share_url'=>'https://www.facebook.com/sharer/sharer.php?u=URL');
        $sites[] = array('id'=>'twitter','title'=>__('Twitter','social-share-button'),'icon'=>'<i class="fab fa-twitter"></i>','can_remove'=>'yes','visible'=>'yes','share_url'=>'https://twitter.com/intent/tweet?url=URL&text=TITLE');
        $sites[] = array('id'=>'reddit','title'=>__('Reddit','social-share-button'),'icon'=>'<i class="fab fa-reddit-alien"></i>','can_remove'=>'yes','visible'=>'yes','share_url'=>'http://www.reddit.com/submit?title=TITLE&url=URL');
        $sites[] = array('id'=>'linkedin','title'=>__('Linkedin','social-share-button'),'icon'=>'<i class="fab fa-linkedin-in"></i>','can_remove'=>'yes','visible'=>'yes','share_url'=>'https://www.linkedin.com/shareArticle?url=URL&title=TITLE&summary=&source=');
        $sites[] = array('id'=>'stumbleupon','title'=>__('Stumbleupon','social-share-button'),'icon'=>'<i class="fab fa-stumbleupon"></i>','can_remove'=>'yes','visible'=>'yes','share_url'=>'http://www.stumbleupon.com/submit?url=URL&title=TITLE');
